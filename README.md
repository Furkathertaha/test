...
$$ \mathbf{D} _p^n = \sum _{i} w _{ip}^n \left( \mathbf{x}_i - \mathbf{x}_p^n \right) \left( \mathbf{x}_i - \mathbf{x}_p^n \right)^T ,\quad(9) $$
...
$$ \mathbf{B} _p^{n+1} = \sum _{i} w _{ip}^{n} \mathbf{\tilde{v}}_i^{n+1} \left( \mathbf{x}_i - \mathbf{x}_p^n \right)^T. \quad (10) $$
